      ...
      <div className="space-y-12">
        <section className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground">
            Your data security and privacy are our top priorities. Learn how we
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Our platform runs on SOC 2 compliant cloud infrastructure with
        ...
        <section className="space-y-6">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="access-control">
              ...
              <AccordionContent>
                <p className="text-muted-foreground">
                  We implement strict access controls based on the principle of
                  least privilege. Only authorized personnel have access to
                  production systems, and all access is logged and monitored. We
            ...
            <AccordionItem value="data-protection">
              ...
              <AccordionContent>
                <p className="text-muted-foreground">
                  Your documents and images are encrypted both in transit and at
                  rest. We use TLS 1.2+ for all data in transit and AES-256
                  encryption for data at rest. Our backup systems are also
                  encrypted to ensure your data remains protected.
                </p>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="vulnerability-management">
              ...
              <AccordionContent>
                <p className="text-muted-foreground">
                  ...
                  that includes regular scanning, penetration testing, and code
                  reviews. Security updates are applied promptly, and we have a
            ...
            <AccordionItem value="incident-response">
              ...
              <AccordionContent>
                <p className="text-muted-foreground">
                  We have a documented incident response plan that is regularly
                  tested and updated. Our team is trained to quickly identify,
                  contain, and remediate security incidents. We commit to
                  transparent communication with affected users in the event of
                  a security breach.
                </p>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="employee-security">
              ...
              <AccordionContent>
                <p className="text-muted-foreground">
                  ...
                  We maintain a security-first culture with regular training
                  sessions and awareness programs. Access to customer data is
                  strictly limited and audited.
                </p>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-muted p-6 rounded-lg space-y-4">
            ...
            <p>
              We take security issues seriously. If you believe you've found a
              security vulnerability in our service, please report it to us
              immediately. We appreciate your help in keeping our platform
              secure.
            </p>
...
const certifications = [
  ...
  },
  {
    name: "GDPR Compliant",
    description:
      "Our platform and processes are designed to comply with the EU General Data Protection Regulation.",
  },
  {
    name: "ISO 27001",
    description:
...
const securityUpdates = [
  ...
  },
  {
    ...
    date: "March 15, 2025",
    description:
      "Applied critical security updates to our PDF processing engine to address potential vulnerabilities.",
  },
  {
    title: "Completed Annual Security Audit",
    date: "February 22, 2025",
    description:
      "Successfully completed our annual comprehensive security audit with no critical findings.",
  },
];
