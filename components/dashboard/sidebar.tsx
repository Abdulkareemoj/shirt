  ...
  function NavItem({
    ...
    return (
      <Link
        ...
        className="flex items-center px-3 py-2 text-sm rounded-md transition-colors text-gray-800 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-[#1F1F23]"
      >
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto py-4 px-4">
            <div className="space-y-6">
              <div>
                <div className="px-3 mb-2 text-sm font-semibold uppercase tracking-wider dark:text-gray-400">
                  Overview
                </div>
                <div className="space-y-1">
                  ...
                  <NavItem href="/dashboard/templates" icon={BarChart2}>
                    Templates
                  </NavItem>
                  <NavItem href="/dashboard/designs" icon={Building2}>
                    Designs
                  </NavItem>
